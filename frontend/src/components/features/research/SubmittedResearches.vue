              ...
              <td class="px-6 py-4 text-right">
                <div class="flex items-center justify-end gap-2">
                  <button 
                    ...
                    class="p-2.5 rounded-full text-blue-600 hover:bg-blue-50 transition-colors"
                    title="View PDF"
                  >
                  ...
                  <template v-else>
                    <button 
                      ...
                      class="p-2.5 rounded-full text-amber-500 hover:bg-amber-50 transition-colors"
                      title="Edit"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <button 
                      ...
                      :class="`p-2.5 rounded-full transition-colors ${isArchived ? 'text-blue-600 hover:bg-blue-50' : 'text-red-500 hover:bg-red-50'}`"
                      :title="isArchived ? 'Restore' : 'Archive'"
                    >
                      <svg v-if="isArchived" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
